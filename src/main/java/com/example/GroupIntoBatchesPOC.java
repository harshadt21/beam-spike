...
class GroupIntoBatchesTestStream {
    ...
    public static class PrintBatchesFn extends DoFn<KV<String, Iterable<String>>, Void> {
        ...
        // Removed DateTimeFormatter as specific timestamps are no longer printed for windows.
        ...
        public void processElement(ProcessContext c) {
            ...
            // Collect events into a list to get total count and for easy printing
